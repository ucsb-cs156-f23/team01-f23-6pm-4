...
public class PublicHolidayQueryServiceTests {
    ...
    @Autowired
    private PublicHolidayQueryService publicholidaysQueryService;

    @Test
    public void test_getJSON() {

        String year = "US";
        String countryCode = "1863";
        ...
        String actualResult = publicholidaysQueryService.getJSON(year, countryCode);
